...
| `gemini-3.5-flash-lite` | Latest low-latency, cost-effective model for high-throughput tasks |
...
| `gemini-3.5-flash-lite` | Free tier latest low-latency, cost-effective model |
